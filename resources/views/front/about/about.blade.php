...
@section('body')
    <main class="main">
        ...
        <div class="container">
            <div class="page-header page-header-big text-center" style="background-image: url('{{asset('/')}}assets/images/banners/3cols/banner-4.jpg')">
                <h1 class="page-title text-black">About us<span class="text-black">Who we are</span></h1>
            </div><!-- End .page-header -->
        </div><!-- End .container -->
