                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="ratings-container">
                                                <div class="ratings">
                                                    <div class="ratings-val" style="width: {{$subCategoryProduct->review_count}}%;"></div><!-- End .ratings-val -->
                                                </div><!-- End .ratings -->
                                                <span class="ratings-text">( {{$subCategoryProduct->review_count}} Reviews )</span>
