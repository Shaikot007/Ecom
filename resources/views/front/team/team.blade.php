...
@section('body')
    <main class="main">
        <div class="page-header text-center" style="background-image: url('{{asset('/')}}assets/images/banners/home/banner-1.jpg')">
            <div class="container">
                <h1 class="page-title">Our team<span>Team</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="about-text text-center mt-3">
                            ...
                            <img src="{{asset('/')}}assets/images/about/about-2/img-1.jpg" alt="image" class="mx-auto mt-6 mb-6"/>
                        </div><!-- End .about-text -->
