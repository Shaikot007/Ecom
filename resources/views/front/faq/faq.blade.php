...
@section('body')
    <main class="main">
        <div class="page-header text-center" style="background-image: url('{{asset('/')}}assets/images/backgrounds/cta/bg-7.jpg')">
            <div class="container">
                <h1 class="page-title text-white">Frequently asked questions<span>FAQ</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
